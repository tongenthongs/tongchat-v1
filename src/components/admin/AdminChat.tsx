...
export default function AdminChat() {
  ...
  return (
    <div className="w-full h-full bg-[#0e1621] text-white flex overflow-hidden font-sans">
        ...
        <div className="p-3 border-b border-[#0e1621]">
          ...
          <div className="flex gap-1 bg-[#0e1621] p-1 rounded-lg">
            <button 
              ...
              className={`flex-1 py-1.5 text-[11px] font-bold rounded transition-none ${filterTab === "ALL" ? "bg-[#2b5278]" : "text-[#7fa9ce]"}`}
            >
              Semua
            </button>
            <button 
              onClick={() => setFilterTab("UNREAD")} 
              className={`flex-1 py-1.5 text-[11px] font-bold rounded transition-none ${filterTab === "UNREAD" ? "bg-[#2b5278]" : "text-[#7fa9ce]"}`}
            >
              Belum Dibaca
            </button>
          </div>
