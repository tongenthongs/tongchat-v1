const fs = require('fs');
const code = fs.readFileSync('src/components/customer/CustomerPortal.tsx', 'utf8');
...
lines.splice(1766, 0, insertion);
fs.writeFileSync('src/components/customer/CustomerPortal.tsx', lines.join('\n'));
